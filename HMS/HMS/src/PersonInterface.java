...
public interface PersonInterface {
    ...
    /**
     *
     * If the Customer is making process,will be able to reservation and reservation cancelling. <br>
     * If the frontdesk is making process, will be able to reservation,reservation cancelling,check-in and check-out.
     * @throws Exception
     */
